/** 14-day pattern chart — daily rows with mini timelines + shared axis. */
...
export function PatternChart({
  ...
  return (
    <div className="bg-surface0 rounded-card p-4">
      ...
      <div className="flex gap-4 mt-3 text-[10px] text-subtext0 font-label">
        <span className="flex items-center gap-1">
          <span className="inline-block w-3 h-2 bg-lavender rounded-sm opacity-70" />{" "}
          Schlaf
        </span>
        <span className="flex items-center gap-1">
